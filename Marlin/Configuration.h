...
#define STRING_CONFIG_H_AUTHOR "(MatterHackers)" // Who made the changes.
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#if BoardPlatform == 2     // LPC1769 env
  #define SERIAL_PORT -1
#elif BoardPlatform == 1   // RAMBo env
  #define SERIAL_PORT 0
#elif BoardPlatform == 3   // LPC1769 env
  #define SERIAL_PORT -1
...
#elif HotEndType == 2 && ExtruderType != 6
